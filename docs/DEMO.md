...
Rondleiding voor admin / product owner. De app moet lokaal draaien (`npm run dev`). Werkbeschrijving: [WERKBESCHRIJVING.md](WERKBESCHRIJVING.md).
...
## Demo-accounts (wachtwoord `demo123`, behalve admin)

| Rol | E-mail | Wachtwoord | Wat je laat zien |
|-----|--------|------------|------------------|
| Admin | `admin@vvl.local` | `admin123` (lokaal) | Beheer, seizoen, AVG, CSV |
...
- Startscherm is **Inschrijven** (geen Dashboard, Planning of Wedstrijden).
